...
IF conflicts with Calum's prior decisions:
  Stop and discuss with Calum first
```
...
- Conflicts with Calum's architectural decisions

**How:**
- Technical reasoning, not defensiveness
- Specific questions
- Reference working tests/code
- Involve Calum if architectural
...
V [Just fix it and show in code]
...
**Why no thanks:** Actions speak. Fix it. Code shows you heard feedback.
...
V "Verified this and you're correct. My understanding was wrong because [reason]. Fixing."
